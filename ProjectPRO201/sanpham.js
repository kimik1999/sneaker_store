    ...
    },
    {
        ...
        function xoa(ma) {
          ...
          function checkout1()
          {
              ...
              if(mn1.value=="") {
                  window.alert("Please enter your emails !!!");
              }
              else 
              {
                  window.alert("Thank you ! Please check your email");
                  window.localStorage.clear();
              }
          }